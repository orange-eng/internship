...
parser.add_argument('--jpg', type=str,default='wilk.png', help='Puppet image name to animate (with filename extension), e.g. wilk.png')
parser.add_argument('--jpg_bg', type=str, default='wilk_bg.jpg',help='Puppet image background (with filename extension), e.g. wilk_bg.jpg')
