...
def get_context_and_negative_samples(gul, args):
    ...
    # u类别context和neg; u累呗context和neg; u节点; v节点;
    return context_dict_u, neg_dict_u, context_dict_v, neg_dict_v,gul.node_u,gul.node_v
...
def main():
    ...
    args.train_data, args.test_data, args.vectors_u, args.vectors_v = '../data/wiki/rating_train.dat','../data/wiki/rating_test.dat','../data/wiki/vectors_u.dat','../data/wiki/vectors_v.dat'
