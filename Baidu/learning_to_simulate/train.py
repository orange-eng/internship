...
flags.DEFINE_integer('num_steps', int(2e3), help='Number of steps of training.')
flags.DEFINE_float('noise_std', 6.7e-4, help='The std deviation of the noise.')
flags.DEFINE_string('model_path', 'tmp/models/WaterDropSample',
                    help=('The path for saving checkpoints of the model. '
                          'Defaults to a temporary directory.'))
flags.DEFINE_string('output_path', 'tmp/rollouts/WaterDropSample',
