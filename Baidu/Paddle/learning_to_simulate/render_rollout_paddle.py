...
#flags.DEFINE_string("rollout_path", 'tmp/rollouts/WaterRamps_{}pkl/rollout_test_{}.pkl'.format(NUM_STEPS,NUMBER), help="Path to rollout pickle file")
flags.DEFINE_string("rollout_path", 'tmp/rollouts/WaterDropSample_{}pkl/rollout_test_{}.pkl'.format(NUM_STEPS,NUMBER), help="Path to rollout pickle file")
...
def main(unused_argv):
  ...
  for ax_i, (label, rollout_field) in enumerate(
    ...
    ax.set_xlim(bounds[0][0], bounds[0][1])   # x的变化范围是0.1~0.9
    ax.set_ylim(bounds[1][0], bounds[1][1])   # y的变化范围是0.1~0.9
  ...
  #unused_animation.save('learning_to_simulate/images/WaterRamps/100/large_bounds_{}.gif'.format(NUMBER),fps=75,writer='imagemagick')
  unused_animation.save('learning_to_simulate/images/WaterDropSample/1000000/{}.gif'.format(NUMBER),fps=75,writer='imagemagick')
