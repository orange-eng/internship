...
parser.add_argument('--image', type=str, default='try_image/3.jpg', help='input image')  # required=True
parser.add_argument('--output', type=str, default='result/result3.jpg', help='output image')
